...
export const $RasterMap = {
    ...
    required: ['id', 'elementCode', 'mapSheetNumber', 'mapSheetName', 'dataType', 'headerFileName', 'dataFileName', 'metadataFileName', 'imageSource', 'imageResolution', 'elevationDatum', 'terrainCategory', 'mapScale', 'coordinateSystemType', 'mapProjection', 'centralMeridianLongitude', 'lowerLeftX', 'lowerLeftY', 'upperRightX', 'upperRightY', 'captureDate', 'remark']
} as const;
